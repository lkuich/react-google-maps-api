(function (global, factory) {
  ...
  <svg fill="${color}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240">
	...
	function GroundOverlayFunctional({ url, bounds, options, visible, debug }) {
	    const map = require$$0.useContext(MapContext);
	    ...
	    const groundOverlay = require$$0.useMemo(() => {
	...
	const GroundOverlayF = require$$0.memo(GroundOverlayFunctional);
