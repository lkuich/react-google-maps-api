import { type ContextType, PureComponent, useEffect, useContext, useMemo, memo } from 'react'
...
function GroundOverlayFunctional({ url, bounds, options, visible, debug }: GroundOverlayProps) {
